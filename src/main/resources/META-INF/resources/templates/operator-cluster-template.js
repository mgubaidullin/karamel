const OperatorClusterTemplate = `
<div>
    <section class="pf-c-page__main-section dashboard-subtitle">
        <h1 class="pf-c-title pf-m-xl">Cluster operator</h1>
    </section>
    <section class="pf-c-page__main-section">
        <div class="pf-l-gallery pf-m-gutter dashboard">
            <div v-for="deployment in clusterDeployments" :key="deployment.uid" class="pf-c-card pf-m-hoverable pf-m-compact">
            ...
            <div v-for="replicaSet in clusterReplicaSets" :key="replicaSet.uid" class="pf-c-card pf-m-hoverable pf-m-compact">
                <div class="pf-c-card__title pf-m-md status">
                    <p>{{replicaSet.kind}}</p>
                    <div class="pf-c-content">
            ...
            <div v-for="pod in clusterPods" :key="pod.uid" class="pf-c-card pf-m-hoverable pf-m-compact">
                <div class="pf-c-card__title pf-m-md status">
                    <p>Pod</p>
                    <div class="pf-c-content">
                        <small>{{pod.uid}}</small>
        ...
        <div v-show="clusterPods.length === 0 && clusterReplicaSets.length === 0 && clusterDeployments.length ===0" class="pf-l-bullseye">
...
export { OperatorClusterTemplate }